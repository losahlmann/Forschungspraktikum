...
\section{Dynamic Semantics}
    ...
    \begin{definition}\label{def:termvars}
        ...
        The valuation of a concrete term can hence also be seen as a mapping from the values of $\delayvars$ and $\delaydiffvars$ into the reals
        instead of using a functional state space.
        This gives rise to the definition of the \emph{augmented trajectory} $\augtrajectory[s]{\astrm}\from\compactum{0}{r}\to\R^{\abs{\delayvars[\astrm]}}$
    ...
    \begin{lemma}[Differential Lemma]\label{lm:differential-lemma}
        ...
        is piecewise continuously differentiable and for all $\zeta\in\compactum{0}{r}$ it holds:
        \begin{equation*}
    ...
    \begin{proof}
        ...
        In this case $\trajectory(\zeta)(x)(c)=\trajectory(0)(x)(c+\zeta)$ is continuously differentiable and $\DD{\trajectory(t)(x)(c)}{t}(\zeta)=\trajectory(\zeta)(\D{x})(c)$
