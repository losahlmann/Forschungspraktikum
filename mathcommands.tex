...
% parentheses for operator arguments
...
\renewcommand{\powerset}{\mathcal{P}\parentheses}
...
\newcommand{\access}{\rho}
\newcommand{\worlds}{W}
\newcommand{\valuation}{L}
\newcommand{\aswrld}{\nu}
\newcommand{\bswrld}{\omega}

\renewcommand{\substl}[3][]
           {{#1}(#3/#2)}
...
\renewcommand{\freevars}{\operatorname{FV}\parentheses}
\renewcommand{\boundvars}{\operatorname{BV}\parentheses}
\renewcommand{\mustboundvars}{\operatorname{MBV}\parentheses}

% History Horizon
\newcommand{\HH}{\operatorname{HH}\parentheses}
% \newcommand{\HHtrm}{\operatorname{HH_{\ltermsname}}\parentheses}
% \newcommand{\HHfml}{\operatorname{HH_{\lformulasname}}\parentheses}
% \newcommand{\HHprg}{\operatorname{HH_{\lprogramsname}}\parentheses}
