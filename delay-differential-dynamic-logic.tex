...
\section{Syntax}
    ...
    % TODO: finite sets, or sets infinite, but only finitely many symbols in one term/formula
    ...
    %and \emph{predicate symbols} $p,q,r$
...
\section{Dynamic Semantics}
    ...
    \begin{figure}
        \centering
        \input{figures/differential-lemma}
