...
\usepackage[postfixflatinterpret,bracketmodalinterpret,fixformat,silentconst,precisenames]{dL}
...
\section{Axioms}
    ...
    \begin{calculus}
        ...
        \cinferenceRule[iterateb|$k$]{loop unrolling}{
            \linferenceRule[equiv]{
    ...
    \subsection{Delay Differential Induction}
        ...
        \begin{calculus}
            \cinferenceRule[DDI|DDI]{delay differential induction proof rule}{
                \linferenceRule[sequent]{
                    \lsequent{\Gamma}{\inv,\Delta}
                    &\lsequent{\ivr,0\leq t\leq\tau,\inv(\theta(t-\tau))}{\dbox[]{\hevolve{\Dupdate{\Dumod{\D{x}}{\rho(x,\theta(t-\tau))}}}}{\der{\inv}}}
                    &\lsequent{\inv}{\phi}
                }{
                    \lsequent{\Gamma}{\dbox[]{\hevolvein{\D{x}=\rho(x,\xtau)}{\ivr}}{\phi,\Delta}}
                }
        ...
        \begin{sequentdeduction}[]
            \linfer[stepsb]{
                ...
                \lsequent{\Gamma(\xtau)}{\dbox{\hrepeat{(\hupdate{\humod{t}{0}}; \hevolvein{\D{t}=1\syssep \D{x}=\eta(x,\xtau)}{(\ivr\land 0\leq t\leq\tau))}}}{\phi(\xtau),\Delta}}}
            }
