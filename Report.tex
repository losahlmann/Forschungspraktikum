...
% TODO: History Axiom
        ...
        \subsection{Axiom of Steps}
            ...
            % Let $\theta_0$ and $\theta$
            \begin{calculus}
                % TODO: stepsb actually doesn't need to be in a box?
                \cinferenceRule[stepsb|stpsb]{method of steps axiom}{
                    \linferenceRule[equiv]{
                        \dbox[]{\prepeat{(\hupdate{\humod{t}{0}};\hevolvein{\D{t}=1\syssep \D{x}=\rho(x,\xtau)}{(\ivr\land 0\leq t\leq\tau)})}}{\phi}
                    }{
            ...
            \begin{calculus}
                ...
                \cinferenceRule[steps|stps]{steps proof rule}{
                    \linferenceRule[sequent]{
                        ...
                        &\lsequent{t=0,F(\theta(t-\tau))}{\dbox[]{\hevolvein{\D{t}=1\syssep \D{x}=\rho(x,\theta(t-\tau))}{(\ivr\land 0\leq t\leq\tau)}}{F}}
                        &\lsequent{F}{\phi}
                    }{
                        \lsequent{\Gamma}{\dbox[]{\hevolvein{\D{x}=\rho(x,\xtau)}{\ivr}}{\phi},\Delta}
                    }
                }{}
            \end{calculus}
            ...
            \begin{calculus}
                \cinferenceRule[DDI|DDI]{delay differential induction proof rule}{
                    \linferenceRule[sequent]{
                        ...
                        &\lsequent{\ivr,0\leq t\leq\tau,F(\theta(t-\tau))}{\dbox[]{\hevolve{\Dupdate{\Dumod{\D{x}}{\rho(x,\theta(t-\tau))}}}}{\der{F}}}
                        &\lsequent{F}{\phi}
                    }{
                        \lsequent{\Gamma}{\dbox[]{\hevolvein{\D{x}=\rho(x,\xtau)}{\ivr}}{\phi,\Delta}}
                    }
                        ...
                        &\linfer[assignb,composeb]{
                            \linfer[DC]{
                                \linfer[DC]{
                                    ...
                                    \lsequent{F(\xtau),t=0}{\dbox{\hevolvein{\D{t}=1\syssep \D{x}=\eta(x,\xtau)}{(\ivr\land 0\leq t\leq\tau\land F(x(t-\tau)))}}{F(\xtau)}}
                                }
                                &\linfer[]{
                                    (2)
                                }{
                                    \lsequent{F(\xtau),t=0}{\dbox{\hevolvein{\D{t}=1\syssep \D{x}=\eta(x,\xtau)}{(\ivr\land 0\leq t\leq\tau)}}{F(x(t-\tau))}}
                                }
                            }{
                                \lsequent{F(\xtau),t=0}{\dbox[]{\hevolvein{\D{t}=1\syssep \D{x}=\eta(x,\xtau)}{(\ivr\land 0\leq t\leq\tau)}}{F(\xtau)}}
                            }
                        }{
                            \lsequent{F(\xtau)}{\dbox[]{\hupdate{\humod{t}{0}}; \hevolvein{\D{t}=1\syssep \D{x}=\eta(x,\xtau)}{(\ivr\land 0\leq t\leq\tau)}}{F(\xtau)}}
                        }
                        \lsequent{F(\xtau)}{\phi(\xtau)}
                    }{
                    \lsequent{\Gamma(\xtau)}{\dbox{\prepeat{(\hupdate{\humod{t}{0}}; \hevolvein{\D{t}=1\syssep \D{x}=\eta(x,\xtau)}{(\ivr\land 0\leq t\leq\tau))}}}{\phi(\xtau),\Delta}}}
                }
                {\lsequent{\Gamma(\xtau)}{\dbox{\hevolvein{\D{x}=\eta(x,\xtau)}{\ivr}}{\phi(\xtau),\Delta}}}
                        ...
                        \linfer[allR]{
                            \linfer[implyR]{
                                \linfer[]{
                                    ...
                                    \lsequent{\lforall{s\in[-\tau,0]}{F(\theta(s))},t=0,\ivr(r,y),0\leq r\leq\tau}{F(\theta(r-\tau))}
                                }
                            }{
                                \lsequent{\lforall{s\in[-\tau,0]}{F(\theta(s))},t=0}{\ivr(r,y)\land 0\leq r\leq\tau\limply F(\theta(r-\tau))}
                            }
                        }{
                            \lsequent{\lforall{s\in[-\tau,0]}{F(\theta(s))},t=0}{\lforall{(t,x)}{(\ivr\land 0\leq t\leq\tau\limply F(\theta(t-\tau)))}}
                        }
                    }{
                        \lsequent{\lforall{s\in[-\tau,0]}{F(\theta(s))},t=0}{\dbox{\hevolvein{\D{t}=1\syssep \D{x}=\eta(x,\theta(t-\tau))}{(\ivr\land 0\leq t\leq\tau)}}{F(\theta(t-\tau))}}
                    }
                }{
                    \lsequent{F(\xtau),t=0}{\dbox{\hevolvein{\D{t}=1\syssep \D{x}=\eta(x,\xtau)}{(\ivr\land 0\leq t\leq\tau)}}{F(x(t-\tau))}}
                }
                ...
                \linfer[DC]{
                    \linfer[dI]{
                        \linfer[hist]{
                            ...
                            \lsequent{F(\xtau),t=0,A, F(x(t-\tau))}{F(x(t))}
                        }
                        % TODO: A=\ivr, 0\leq t\leq\tau
                        &\lsequent{A, F(\theta(t-\tau)))}{\dbox{\Dupdate{\Dumod{\D{t}}{1},\Dumod{ \D{x}}{\eta(x,\theta(t-\tau))}}}{\der{F(x(t))}}}
                        %}
                    }{
                        \lsequent{F(\xtau),t=0}{\dbox{\hevolvein{\D{t}=1\syssep \D{x}=\eta(x,\xtau)}{(A\land F(x(t-\tau)))}}{F(x(t))}}
                    }
                    &\linfer[hist]{
                        (3)
                    }{
                        \lsequent{F(\xtau),t=0}{\dbox{\hevolvein{\D{t}=1\syssep \D{x}=\eta(x,\xtau)}{(A\land F(x(t-\tau))\land F(x(t)))}}{F(\xtau)}}
                    }
                }{
                    \lsequent{F(\xtau),t=0}{\dbox{\hevolvein{\D{t}=1\syssep \D{x}=\eta(x,\xtau)}{(A\land F(x(t-\tau)))}}{F(\xtau)}}
                }
            \end{sequentdeduction}
            % TODO: ref here (3)
            \begin{sequentdeduction}
                        ...
                        \linfer[allR]{
                            \linfer[implyR]{
                                \linfer[]{
                                    ...
                                    \lsequent{\lforall{s\in[-\tau,0]}{F(\theta(s))}, t=0, \ivr(r,y), 0\leq r\leq\tau, F(\theta(r-\tau)), F(\theta(r))}{\lforall{s\in[-\tau,0]}{F(\theta(r+s))}}
                                }
                            }{
                                \lsequent{\lforall{s\in[-\tau,0]}{F(\theta(s))}, t=0}{((\ivr(r,y)\land 0\leq r\leq\tau\land F(\theta(r-\tau))\land F(\theta(r)))\limply\lforall{s\in[-\tau,0]}{F(\theta(r+s))})}
                            }
                        }{
                            \lsequent{\lforall{s\in[-\tau,0]}{F(\theta(s))}, t=0}{\lforall{(t,x)}{((A\land F(\theta(t-\tau))\land F(\theta(t)))\limply\lforall{s\in[-\tau,0]}{F(\theta(t+s))})}}
                        }
                    }{
                        \lsequent{\lforall{s\in[-\tau,0]}{F(\theta(t+s))}, t=0}{\dbox{\hevolvein{\D{t}=1\syssep \D{x}=\eta(x,\theta(t-\tau))}{(A\land F(\theta(t-\tau))\land F(\theta(t)))}}{(\lforall{s\in[-\tau,0]}{F(\theta(t+s))})}}
                    }
                }{
                    \lsequent{F(\xtau),t=0}{\dbox{\hevolvein{\D{t}=1\syssep \D{x}=\eta(x,\xtau)}{(A\land F(x(t-\tau))\land F(x(t)))}}{F(\xtau)}}
                }
                    ...
                    \linfer[DDI]{
                        ...
                        &\linfer[]{
                            \linfer[]{
                                ...
                                \lsequent{0\geq t\geq\tau,\theta(t)^3\geq 0}{\dbox{\Dupdate{\Dumod{\D{x}}{\theta(t)}}}{(3x(t)^2 \D{x}\geq 0)}}
                            }
                        }{
                            %\lclose
                            \lsequent{0\geq t\leq\tau,\theta(t)^3\geq 0}{\dbox{\Dupdate{\Dumod{\D{t}}{1},\Dumod{\D{x}}{\theta(t)}}}{\der{x\geq 0}}}
                        }
                        &\linfer[]{
                            \lclose
                        }{
                        ...
                        \lsequent{\xtau[1]\geq 0}{\dbox{\D{x}=\xtau[1]}{(\xtau[1]\geq 0)}}
                    }
                \end{sequentdeduction}
                    ...
                    \linfer[DDI]{
                        ...
                        &\linfer[]{
                            \linfer[]{
                                ...
                                \lsequent{0\leq t\leq\tau,\theta(t)^3\leq 0}{\dbox{\Dupdate{\Dumod{\D{x}}{-\theta(t)^2}}}{(-3x(t)^2 \D{x}\leq 0)}}
                            }
                        }{
                            %\lclose
                            \lsequent{0\leq t\leq\tau,\theta(t)^3\leq 0}{\dbox{\Dupdate{\Dumod{\D{t}}{1},\Dumod{\D{x}}{-\theta(t)^2}}}{\der{x\leq 0}}}
                        }
                        &\linfer[]{
                            \lclose
                        }{
                        ...
                        \lsequent{\xtau[1]\leq 0}{\dbox{\D{x}=-\xtau[1]^2}{(\xtau[1]\leq 0)}}
                    }
                \end{sequentdeduction}
