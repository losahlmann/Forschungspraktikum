...
\section{Axioms}
        ...
        \begin{calculus}
            ...
            \cinferenceRule[DC|DC]{differential cut}{
                \linferenceRule[lpmi]{
                    ...
                    \lbisubjunct
                    \dbox{\hevolvein{\D{x}=\astrm}{\ivr\land\varrho}}{\asfml}\right)
                }{
                    \dbox{\hevolvein{\D{x}=\astrm}{\ivr}}{\varrho}
                }
            }{}
            ...
            \cinferenceRule[DI|DI]{differential invariant}{
                \linferenceRule[lpmi]{
                    ...
                    \left(\ivr\limply\asfml\land\dbox{\hevolvein{\D{x}=\astrm}{\ivr}}{\D{(\asfml)}}\right)
                }
            }{}
    ...
    \begin{proof}
        ...
        % adaption of \cite{Platzer15Uniform}
    \begin{description}
        \item[DC] Let $\asstate\in\imodel{\IddL}{\dbox{\hevolvein{\D{x}=\astrm}{\ivr}}{\varrho}}$ and $\trajectory\from\compactum{0}{\bar{r}}\to\states$ be an arbitrary trajectory of duration $\bar{r}\geq 0$, solving the DDE and having $\asstate$ as initial condition.
        ...
        \item[DE] Let $\asstate\in\imodel{\IddL}{\dbox{\hevolvein{\D{x}=\astrm}{\ivr}}{\asfml}}$ and $\trajectory\from\compactum{0}{r}\to\states$ be a trajectory of duration $r\geq 0$ solving the DDE and having $\asstate$ as initial condition, i.e.\ $\trajectory(0)=\asstate$ on $\scomplement{\set{\D{x}}}$ and $\trajectory(\zeta)\in\imodel{\IddL}{\Dxtau[0]=\asfml\land\ivr}$ for all $\zeta\in\compactum{0}{r}$.
        ...
        \subsubsection{Example 1}
            ...
            \begin{sequentdeduction}
                \linfer[DDI]{
                    ...
                    \lsequent{\holdssince{\tau}{\x[s]\geq 0}}{\dbox{\D{x}=\xtau}{(\holdssince{\tau}{\x[s]\geq 0})}}
                }
            \end{sequentdeduction}\normalsize
