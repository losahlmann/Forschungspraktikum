...
\section{Axioms}
    ...
    \begin{description}
        ...
        \item[DI] This proof is an adaption of the \dL proof for DI given in~\cite{Platzer15Uniform}. Without loss of generality we restrict to the case of invariants of the form $\asfml\equiv(g(x)\geq 0)$. Then $\D{(\asfml)}\equiv(\D{(g(x))}\geq 0)$ (by ??)
