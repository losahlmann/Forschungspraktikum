...
\section{Proof Rules}
    ...
    \subsection{Rule of Steps}
        ...
        ODEs don't have notion of \textit{one step}, but DDEs do.
                    ...
                    &\linfer[assignb,composeb]{
                        \linfer[DC]{
                            \linfer[DC]{
                                ...
                                \lsequent{\inv(\xtau),t=0}{\dbox{\hevolvein{\D{t}=1\syssep \D{x}=\eta(x,\xtau)}{(\ivr\land 0\leq t\leq\tau\land \inv(x(t-\tau)))}}{\inv(\xtau)}}
                            }
                            &\linfer[]{
                                (2)
                            }{
                                \lsequent{\inv(\xtau),t=0}{\dbox{\hevolvein{\D{t}=1\syssep \D{x}=\eta(x,\xtau)}{(\ivr\land 0\leq t\leq\tau)}}{\inv(x(t-\tau))}}
                            }
                        }{
                    ...
                    \linfer[allR]{
                        \linfer[implyR]{
                            \linfer[]{
                                ...
                                \lsequent{\lforall{s\in[-\tau,0]}{\inv(\theta(s))},t=0,\ivr(r,y),0\leq r\leq\tau}{\inv(\theta(r-\tau))}
                            }
                        }{
                            \lsequent{\lforall{s\in[-\tau,0]}{\inv(\theta(s))},t=0}{\ivr(r,y)\land 0\leq r\leq\tau\limply \inv(\theta(r-\tau))}
                        }
                    }{
                        \lsequent{\lforall{s\in[-\tau,0]}{\inv(\theta(s))},t=0}{\lforall{(t,x)}{(\ivr\land 0\leq t\leq\tau\limply \inv(\theta(t-\tau)))}}
                    }
                }{
                    \lsequent{\lforall{s\in[-\tau,0]}{\inv(\theta(s))},t=0}{\dbox{\hevolvein{\D{t}=1\syssep \D{x}=\eta(x,\theta(t-\tau))}{(\ivr\land 0\leq t\leq\tau)}}{\inv(\theta(t-\tau))}}
                }
            }{
                \lsequent{\inv(\xtau),t=0}{\dbox{\hevolvein{\D{t}=1\syssep \D{x}=\eta(x,\xtau)}{(\ivr\land 0\leq t\leq\tau)}}{\inv(x(t-\tau))}}
            }
                ...
                \linfer[dI]{
                    \linfer[hist]{
                        \linfer[]{
                            ...
                            \lsequent{\lforall{s\in[-\tau,0]}{\inv(\theta(s))}}{\inv(\theta(0))}
                        }
                    }{
                        \lsequent{\inv(\xtau),t=0,A, \inv(x(t-\tau))}{\inv(x(t))}
                    }
                    % TODO: A=\ivr, 0\leq t\leq\tau
                    &\lsequent{A, \inv(\theta(t-\tau)))}{\dbox{\Dupdate{\Dumod{\D{t}}{1},\Dumod{ \D{x}}{\eta(x,\theta(t-\tau))}}}{\der{\inv(x(t))}}}
                    %}
                }{
                    \lsequent{\inv(\xtau),t=0}{\dbox{\hevolvein{\D{t}=1\syssep \D{x}=\eta(x,\xtau)}{(A\land \inv(x(t-\tau)))}}{\inv(x(t))}}
                }
                &\linfer[hist]{
                    (3)
                }{
                    \lsequent{\inv(\xtau),t=0}{\dbox{\hevolvein{\D{t}=1\syssep \D{x}=\eta(x,\xtau)}{(A\land \inv(x(t-\tau))\land \inv(x(t)))}}{\inv(\xtau)}}
                }
            }{
                \lsequent{\inv(\xtau),t=0}{\dbox{\hevolvein{\D{t}=1\syssep \D{x}=\eta(x,\xtau)}{(A\land \inv(x(t-\tau)))}}{\inv(\xtau)}}
            }
        \end{sequentdeduction}
        % TODO: ref here (3)
        \begin{sequentdeduction}
                    ...
                    \linfer[allR]{
                        \linfer[implyR]{
                            \linfer[]{
                                ...
                                \lsequent{\lforall{s\in[-\tau,0]}{\inv(\theta(s))}, t=0, \ivr(r,y), 0\leq r\leq\tau, \inv(\theta(r-\tau)), \inv(\theta(r))}{\lforall{s\in[-\tau,0]}{\inv(\theta(r+s))}}
                            }
                        }{
                            \lsequent{\lforall{s\in[-\tau,0]}{\inv(\theta(s))}, t=0}{((\ivr(r,y)\land 0\leq r\leq\tau\land \inv(\theta(r-\tau))\land \inv(\theta(r)))\limply\lforall{s\in[-\tau,0]}{\inv(\theta(r+s))})}
                        }
                    }{
                        \lsequent{\lforall{s\in[-\tau,0]}{\inv(\theta(s))}, t=0}{\lforall{(t,x)}{((A\land \inv(\theta(t-\tau))\land \inv(\theta(t)))\limply\lforall{s\in[-\tau,0]}{\inv(\theta(t+s))})}}
                    }
                }{
                    \lsequent{\lforall{s\in[-\tau,0]}{\inv(\theta(t+s))}, t=0}{\dbox{\hevolvein{\D{t}=1\syssep \D{x}=\eta(x,\theta(t-\tau))}{(A\land \inv(\theta(t-\tau))\land \inv(\theta(t)))}}{(\lforall{s\in[-\tau,0]}{\inv(\theta(t+s))})}}
                }
            }{
                \lsequent{\inv(\xtau),t=0}{\dbox{\hevolvein{\D{t}=1\syssep \D{x}=\eta(x,\xtau)}{(A\land \inv(x(t-\tau))\land \inv(x(t)))}}{\inv(\xtau)}}
            }
