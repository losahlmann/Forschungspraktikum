                ...
                \linfer[DC]{
                    \linfer[dI]{
                        \linfer[hist]{
                            ...
                            \lsequent{F(\xtau),t=0,A, F(x(t-\tau))}{F(t)}
                        }
                        % TODO: A=\ivr, 0\leq t\leq\tau
                        &\lsequent{A, F(x(t-\tau)))}{\dbox{\Dupdate{\Dumod{\D{t}}{1},\Dumod{ \D{x}}{\eta(x,\xtau)}}}{\der{F(x(t))}}}
                        %}
                    }{
                        \lsequent{F(\xtau),t=0}{\dbox{\hevolvein{\D{t}=1\syssep \D{x}=\eta(x,\xtau)}{(A\land F(x(t-\tau)))}}{F(t)}}
                    }
                    &\linfer[hist]{
                        (3)
                    }{
                        ...
                        \linfer[allR]{
                            \linfer[implyR]{
                                \linfer[close]{
                                    ...
                                    \lsequent{\lforall{s\in[-\tau,0]}{F(\theta(s))}, t=0, A, F(\theta(-\tau)), F(\theta(0))}{\lforall{r\in[-\tau,0]}{F(\theta(r))}}
                                }
                            }{
                                \lsequent{\lforall{s\in[-\tau,0]}{F(\theta(s))}, t=0}{((A\land F(\theta(-\tau))\land F(\theta(0)))\limply\lforall{r\in[-\tau,0]}{F(\theta(r))})}
                            }
                        }{
                            \lsequent{\lforall{s\in[-\tau,0]}{F(\theta(s))}, t=0}{\lforall{(t,x)}{((A\land F(\theta(-\tau))\land F(\theta(0)))\limply\lforall{r\in[-\tau,0]}{F(\theta(r))})}}
                        }
                    }{
                        \lsequent{\lforall{s\in[-\tau,0]}{F(\theta(s))}, t=0}{\dbox{\hevolvein{\D{t}=1\syssep \D{x}=\eta(x,\xtau)}{(A\land F(\theta(-\tau))\land F(\theta(0)))}}{(\lforall{r\in[-\tau,0]}{F(\theta(r))})}}
                    }
                }{
                    \lsequent{F(\xtau),t=0}{\dbox{\hevolvein{\D{t}=1\syssep \D{x}=\eta(x,\xtau)}{(A\land F(x(t-\tau))\land F(x(t)))}}{F(\xtau)}}
                }
