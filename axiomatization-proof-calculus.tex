...
\section{Axiomatization}
    ...
    \begin{figure}[t]
        ...
        \begin{calculus}
            ...
            % TODO: add Time Barcan, if useful
        \end{calculus}
        \qquad
        % proof rules
        \begin{calculus}
    ...
    The \emph{discrete assignment axiom}~\irref{assignb} substitutes $\x[0]$ (alias $x$) by its new value $\astrm$ in the formula, requirering the admissibility condition (neither $x$ nor any variable in $\astrm$ get bound by a quantifier or modality, cf.~Section~\ref{sec:variable-binding}) to hold.
    ...
    The \emph{induction axiom}~\irref{I}
    ...
    \subsection{Differential Axioms}
        ...
        \begin{figure}[t]
            ...
            \begin{calculus}
                ...
                % TODO: no precond left and psi replaced by chi on right?
        ...
        % TODO: mention axioms where not allowed
...
%         combine proof rule to tactic
    ...
    \section{Delay Differential Induction}
        ...
        % TODO: write as Lemma: DDI is a derived rule
