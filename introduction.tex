\chapter{Introduction}
    ...
    Formal methods provide a means to systematically obtain proofs of specifications, if the system can be described as a model in a certain formal language.
