...
\section{Existence and Uniqueness of Solutions}
    ...
    \begin{proof}
        ...
        Since $f$ is continuous, it admits an upper bound $K>0$
        on the compact set
        \begin{equation*}
        ...
        \begin{align*}
            ...
            & =\integral{\tzero}{t} \nnorm*{f(s,x(s),x_{\tzero}(s-\tau_1-\tzero),\ldots,x_{\tzero}(s-\tau_k-\tzero))-f(s,\bar{x}(s),x_{\tzero}(s-\tau_1-\tzero),\ldots,x_{\tzero}(s-\tau_k-\tzero))}\dx[s]\\
