...
\section{Definition of Solution}
    ...
    \begin{definition}[Solution of DDE]\label{def:solution-dde}
        ...
        $x$ is continuous and piecewise continuously differentiable on $\compactum{\tzero}{\tzero+T}$
        %(in the sense of Def.~\ref{def:piecewise-continuous})
        with partition $\Delta$.
