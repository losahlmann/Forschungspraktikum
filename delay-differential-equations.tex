...
% show continuity and pw diffable (nth to show)
    ...
    \begin{corollary}\label{cor:continuability-of-solution}
        ...
        If in Theorem~\ref{theorem-solution-existence} $T=\tzero+\taumin$, can reapplay theorem with new starting point $\tzero=\tzero_{old}+t_1-\tau$. Get existence of unique solution on $[\tzero-\tau,\tzero+S]$ with $S>T$.
    \end{corollary}
